...
class appProdProjectContainer extends Container
{
    ...
    {
        require_once 'G:/www/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_5162da0bc4c01.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_aeefe480f8f3ca7c98e4c08489ab81da');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_aeefe480f8f3ca7c98e4c08489ab81da');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_aeefe480f8f3ca7c98e4c08489ab81da');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5162da0bc4c01_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('G:/www/Symfony/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:G:/www/Symfony/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('G:/www/Symfony/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('G:/www/Symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('G:/www/Symfony/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('G:/www/Symfony/app/cache/prod/sessions');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'G:/www/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('G:/www/Symfony/app/cache/prod/jms_security', false));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'profiler.storage.dsn' => 'file:G:/www/Symfony/app/cache/prod/profiler',
            ...
            'swiftmailer.spool.memory.path' => 'G:/www/Symfony/app/cache/prod/swiftmailer/spool',
            ...
            'jms_aop.cache_dir' => 'G:/www/Symfony/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'G:/www/Symfony/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'G:/www/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_5162da0bc4c01.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5162da0bc4c01_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'G:/www/Symfony/app/cache/prod/jms_security',
